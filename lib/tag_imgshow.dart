...
class tagimgshow extends StatefulWidget {

  var showValue;
  tagimgshow({this.showValue,});

  @override
  _tagimgshowState createState() => _tagimgshowState();
}

DateTime dateTime = DateTime.now();

class _tagimgshowState extends State<tagimgshow> {
        ...
        body: WillPopScope(
          ...
          child: SingleChildScrollView(
            child: Container(
              child: Column(
                children: [
                  Image.network(recvdValue.url, fit: BoxFit.fill,),
                  SizedBox(height: 10,),
                  Row(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        child: Text('${finTxt.replaceAll(']', '').replaceAll('[', '').replaceAll(',', '')}', style: TextStyle(color: Colors.green, fontFamily: 'Poppins',
                            fontSize: 12
                        ),
